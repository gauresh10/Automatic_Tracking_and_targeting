...
connect the power terminal of servos to +5 external power supply
connect gnd of arduino and servo to the gnd of external power supply

*/
#include <Servo.h>  //Used to control the Pan/Tilt Servos

//These are variables that hold the servo IDs.
char tiltChannel=0, panChannel=1,ledch=2;
...
char serialChar=0;
 int led =11;
void setup(){
  servoTilt.attach(5);  //The Tilt servo is attached to pin 3.
  servoPan.attach(3);   //The Pan servo is attached to pin 5.
